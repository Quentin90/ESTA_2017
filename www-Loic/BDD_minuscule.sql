...
Create Table Etudiant(
	...
	semestre_etranger_etudiant varchar(35), -- Clé étrangere
...
Create Table Ancien_Eleve(
	...
	diplome_ancien_eleve varchar(50),
	nom_ancien_eleve varchar(50),
	prenom_ancien_eleve varchar(50),
	2A2E_ancien_eleve varchar(50),
	compte_likedin_ancien_eleve varchar(50),
	nom_marital_ancien_eleve varchar(50),
	date_promoBACplus4_ancien_eleve year,
	date_promoBACplus5_ancien_eleve year,
	portable_ancien_eleve varchar(50),
	telephone_fix_ancien_eleve varchar(50),
	mail_ancien_eleve varchar(80),
	commentaires_envoi_ancien_eleve varchar(100),
	poste_occupe varchar(100),
	categorie_poste_occupe_ancien_eleve varchar(100),
	salaire_moyen_ancien_eleve varchar(100),
	nom_entreprise_ancien_eleve varchar(100),
