    ...
    <table class="container">
        ...
        <?php if(isset($data)):?>
            <?php foreach ($data as $value){ ?>
                <tr>
                    <td>
                        <form method="post" action="../../../App/Controller/Admin/AssociationEtudianteDelete.php" TARGET="_blank">
                            <input type="hidden" name="id" value="<?= $value['id_association_etudiante']; ?>">
